...
export const UPDATE_INSTRUMENT = gql`
  mutation UpdateInstrument($id: String!, $year: String!, $brand: String!, $type: String!, $price: String!, $artistId: artist!) {
    updateInsrtument(id: $id, year: $year, brand: $brand, model: $model, price: $price, characterId: $characterId) {
      id
      year
      brand
      type
